...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fiscal'
        db.create_table(u'Fiscais_fiscal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'Fiscais', ['Fiscal'])

        # Adding M2M table for field salas on 'Fiscal'
        m2m_table_name = db.shorten_name(u'Fiscais_fiscal_salas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fiscal', models.ForeignKey(orm[u'Fiscais.fiscal'], null=False)),
            ('sala', models.ForeignKey(orm[u'Fiscais.sala'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fiscal_id', 'sala_id'])


    def backwards(self, orm):
        # Deleting model 'Fiscal'
        db.delete_table(u'Fiscais_fiscal')

        # Removing M2M table for field salas on 'Fiscal'
        db.delete_table(db.shorten_name(u'Fiscais_fiscal_salas'))
    ...
    models = {
        u'Fiscais.fiscal': {
            ...
            'salas': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Fiscais.Sala']", 'symmetrical': 'False'}),
